...
class myBinaryMinHeap {
    public:
        explicit myBinaryMinHeap( int capacity = 100 ){
            ...
            currentSize = 0;
            // cout<<"myBinaryMinHeap::array.capacity(): "<<myBinaryMinHeap::array.capacity()<<endl;
        ...
        */
        void insert( const Comparable & x ){
            ...
            // Comparable blank = Comparable();
            // array.push_back(blank);
        ...
        */
        ...
        void print(int start_at = 0){
            ...
            // cout<<"space_locations_len:"<<space_locations_len<<endl;
