...
class myDlList {
    ...
    public:
        ...
        typename myDlList<Object>::iterator find(typename myDlList<Object> ::const_iterator from,
                                                 typename myDlList<Object> ::const_iterator to,
                                                 const    Object & x ) const{
            const_iterator currentPosition = from;
            while (currentPosition != to){
                if (*currentPosition == x) return iterator(currentPosition.current);
                else currentPosition++;
            }
            return iterator(currentPosition.current);
        }
